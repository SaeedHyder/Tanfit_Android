...
public class PagerIndicator extends LinearLayout implements ViewPagerEx.OnPageChangeListener{
    ...
    public PagerIndicator(Context context, AttributeSet attrs) {
       ...
       /* mDefaultSelectedColor = Color.parseColor("#939EAD");
        ...
        mDefaultSelectedHeight = attributes.getDimensionPixelSize(R.styleable.PagerIndicator_selected_height,(int)pxFromDp(context.getResources().getDimension(R.dimen.x4)));

        mDefaultUnSelectedWidth = attributes.getDimensionPixelSize(R.styleable.PagerIndicator_unselected_width,(int)pxFromDp(context.getResources().getDimension(R.dimen.x3)));
        mDefaultUnSelectedHeight = attributes.getDimensionPixelSize(R.styleable.PagerIndicator_unselected_height,(int)pxFromDp(context.getResources().getDimension(R.dimen.x3)));
