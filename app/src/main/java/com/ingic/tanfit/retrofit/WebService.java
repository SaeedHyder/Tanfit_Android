...
*/
    ...
    @FormUrlEncoded
    @POST("api/User/SearchNearestStudios")
    ...
    @GET("api/User/GetUserFitnessClasses")
    Call<ResponseWrapper<ArrayList<UserFitnessClasses>>> getUserFitnessClasses(
            @Query("userId") String userId);
